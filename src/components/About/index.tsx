          ...
          <div className="info-container">
            <div
              ...
              onTouchMove={(e) => {
                ...
                if (deltaY > deltaX) {
                  // Dikey swipe ise Swiper'a gitmesin
                  e.stopPropagation();
                }
              }}
            >
              ...
              <div className="paragraph">
                <p>
                  ...
                  people and share experiences. On July 20, 2024, I got engaged
                  to{" "}
                ...
                <p>
                  ...
                  place in swimming competitions and also played amateur
                  handball and football. These experiences shaped my discipline,
                  perseverance, and teamwork. Beyond sports, I’m passionate
                  about video games, exploring new worlds, and growing my
                  collection of unique items. I enjoy learning new skills,
                  staying creative, and surrounding myself with inspiring
                  people, always seeking passion, friendships, and meaningful
            ...
            >
              ...
              <div className="paragraph">
                ...
                <p>
                  ...
                  opportunities, working on a project in Canada to design the
                  user interface for an application, while also taking on
                  various freelance projects in Turkey. These experiences
                  allowed me to combine my skills in both frontend and backend
                  development, work with diverse teams across the globe, and
                  continuously challenge myself to create user-friendly and
                ...
                <p>
                  ...
                  <span className="gradient-career">continuously growing</span>{" "}
                  in my career.
                </p>
              </div>
            </div>
